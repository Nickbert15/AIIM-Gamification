...
import { promptNavigatorDemoGame as DEMO_PROMPT_BRANCHING_GAME } from '@/content/promptNavigatorDemo'
...
export default function GamesClient({ games: initialGames }: Props) {
  const [games, setGames] = useState<Game[]>([...initialGames, DEMO_HALLUCINATION_V2_GAME, DEMO_PROMPT_ARENA_GAME, DEMO_PROMPT_BRANCHING_GAME])
